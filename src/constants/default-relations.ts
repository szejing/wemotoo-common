...
export const defaultOrderRelations = ['items', 'items.appointment', 'items.discounts', 'payments', 'discounts', 'customer'];

export const defaultSaleRelations = ['items', 'items.appointment', 'items.discounts', 'payments', 'discounts', 'customer'];
