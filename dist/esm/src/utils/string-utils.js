 ...
 * @returns The truncated string
 */
export function truncateFront(str, maxLength) {
    if (str.length <= maxLength) {
        return str;
    }
 ...
 */
export function extractAfterSeparator(str, separator) {
 ...
 */
export function extractBeforeSeparator(str, separator) {
    const parts = str.split(separator);
 ...
 */
export function removeMerchantId(str) {
